...
I am going to try to fit a multi-level model to see what best predicts immorality. 
...
mod <- brm(data = d_long, 
           formula = immoral_z ~ 1 + harm_z + unexpected_z + deflection_z + (1 | scenario) + (1 | id), family = gaussian, iter = 6000, 
           warmup = 1000, 
           cores = 4, 
           chains = 4)
